    ...
    let elementoModificado = document.querySelector(".formulario > h2")
    elementoModificado.innerHTML = `¡Hola ${nbre}! Gracias por confiar en nosotros!`;
        
    if(numTel.value.length>0){

      li.innerHTML = `Te llamaremos al ${numTel.value} para coordinar tu cita`;
    }else{
      li.innerHTML = `Te escribiremos al ${txtMail.value} para coordinar tu cita`;
    }
